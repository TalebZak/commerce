# Generated by Django 3.0.3 on 2020-09-09 21:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_type', models.CharField(choices=[('FU', 'Furniture'), ('CL', 'Clothing'), ('EN', 'Entertainment'), ('OTH', 'Other')], max_length=3)),
                ...
                ('image', models.ImageField(blank=True, default='images/no-image.png', null=True, upload_to='images/%Y/%m/%D/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='auctions.Product')),
